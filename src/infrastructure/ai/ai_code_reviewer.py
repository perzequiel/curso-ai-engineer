...
# Este es el wrapper de Anthropic
class AICodeReviewer(ICodeReviewer):
    ...
    def review_code(self, code: CodeContent) -> ReviewResult:
        ...
        # SystemPrompt: El rol o config que le doy al agente para que haga lo que quiera que haga
        # HumanMessage: que es el input específico de esta tarea, es lo que ingresa el usuario.
        # SystemMessage: que es lo que devuelve el agente, que es el output
