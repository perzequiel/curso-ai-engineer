"""Clase 3: ICodeReviewer - Puerto para el revisor de codigo IA.

Define la interface abstracta para el componente que evalua
codigo usando inteligencia artificial.
"""
