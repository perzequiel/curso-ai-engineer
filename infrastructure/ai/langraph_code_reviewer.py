...
from domain.ports.code_reviewer import CodeContent, ICodeReviewer, ReviewResult
...
class LangraphCodeReviewer(ICodeReviewer):
    ...
    def _review_node(self, state: ReviewState) -> dict:
        """Revisa el codigo y genera, rating+ summary+ recomendations"""
